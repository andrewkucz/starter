        ...
        {todos && (
          <>
            ...
            <form onSubmit={handleSubmit} className="mt-4 flex flex-col gap-2 sm:flex-row">
              <input type="text" name="title" className="demo-input min-w-0 flex-1" />
...
function DBConnectionError() {
  return (
    <div className="text-center space-y-6">
      ...
      <div className="demo-muted text-lg mb-6">The Neon database is not connected.</div>
      <div className="demo-card max-w-xl mx-auto text-left">
        ...
        <ul className="space-y-4 text-left list-none">
          ...
          <li className="flex items-start">
            ...
            <div>
              Set the <code>DATABASE_URL</code> environment variable to the connection string of
              your Neon database
            </div>
          </li>
        </ul>
